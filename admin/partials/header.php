...
<head>
    ...
    <!-- preload images -->
    <link rel="preload" as="image" href="<?= ROOT_URL ?>images/pattern-2.svg" />
    <link rel="preload" as="image" href="<?= ROOT_URL ?>images/pattern-3.svg" />
</head>
            ...
            <nav class="navbar" data-navbar>
                ...
                <ul class="navbar-list">
                    ...
                    <?php if (!isset($_SESSION['signinSuccess'])) : ?>
                        <li>
                            <a href="<?= ROOT_URL ?>signin.php" class="navbar-link hover-1 btn-primary" data-nav-toggler>Sign in</a>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php if (isset($_SESSION['signinSuccess'])) : ?>
                        <li class="navbar-bottom">
                            <div class="profile-card">
                                <img src="<?= ROOT_URL ?>images/<?= $_SESSION['avatar'] ?>" width="32" height="32" alt="change name with user" class="profile-banner" />
